...
## 🏛️ FOUNDATIONAL — Roy no-TG-less canon + structural invariant (2026-07-10, SCHEDULED post-demo; scope delivered to supervisor)
...
**WHERE it lands:** a hive-canon doc (recommended `docs/HIVE-ARCHITECTURE-CANON.md`, or AGENTS.md policy) = the hive-implementation VIEW of spec-canon, MIRRORING (not forking) specs R2-TG / R2-ARCH / the provisioning spec. Awaiting supervisor's doc-location confirm.
