...
- **NO WRITE TO ANY BOARD.** Grant comes from supervisor AFTER attestation, pinned to ELF sha256 `4e595a45…49ac8`. Artifact non-secret (public build); the persona blob is secret-bearing ⇒ gitignored, digest-only, never committed/published.
