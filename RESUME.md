...
- **DEPENDENCIES before path-1 impl:** (1) spec ratify ✅ DONE (§3.2.6); (2) **Roy scope-eyeball — HELD** (reported supervisor 803ad66-turn, awaiting Roy-scope call); (3) core add SetRxDutyCycle (r2-sx1262) — NOT yet requested. **HELD on Roy scope per supervisor report-plan-before-deep-impl gate. On Roy GO: request core SetRxDutyCycle, then build 1b/1c behind off-by-default `standby` feature vs LIVE dfr1195-fw. Do NOT request core or touch firmware before Roy scope confirm.**
